            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        >
                            <div className={`group relative rounded-xl overflow-hidden ${index % 2 === 0 ? "md:order-1" : "md:order-2"}`}>
                                ...
                                <img
                                    src={project.image}
                                    alt={project.title}
                                    className="w-full h-80 object-cover transform group-hover:scale-105 transition-transform duration-500 rounded-xl border border-white/10"
                                />
                            </div>
                            ...
                            <div className={`text-center md:text-left ${index % 2 === 0 ? "md:order-2" : "md:order-1"}`}>
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center text-fuchsia-400 font-semibold hover:text-fuchsia-300 transition-colors group"
                                >
                                    View Case Study
                ...
                <div className="text-center mt-16">
                    <button
                        ...
                        className="inline-block bg-gradient-to-r from-violet-600 to-fuchsia-500 text-white px-10 py-4 rounded-lg font-semibold text-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 shadow-lg"
                    >
